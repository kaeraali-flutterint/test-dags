...
These DAGs are written for an Airflow 3.3.1 installation, they've been tested in an AWS MWAA environment but should work anywhere as long as you have the right dependencies
